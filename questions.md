...
Quelle est la première femme à avoir obtenu le prix nobel ? (Marie Curie)
...
Quel grande entreprise française porte un nom qui est à la fois une couleur et un agrume ? (orange)
...
Quelle lettre majuscule est spécifiquement associée au permis moto ? (A)
...
Dans les horoscopes, quel signe du zodiaque débute l'année astrologique ? (bélier)
...
Quel mot de trois lettres qualifie un itinéraire routier utilisé pour éviter les axes encombrés ? (bis)
...
Dans cette série télévisée en noir et blanc de 63, quelle arme est associée à Thierry ? (fronde)
...
Quelles petites rondelles de papier coloré a-t-on l'habitude de lancer les jours de fête ? (confettis)
...
Les CRS chargés du maintien de l'ordre sont-ils des policiers ou des gendarmes ? (policiers)
...
Dans quelle ville peut-on flâner sur la Place rouge ? (Moscou)
...
Dans le dessin animé "les Simpson", dans quelle ville habitent Homer et sa famille ? (Springfield)
...
Quel est le titre de la chanson de Queen dans lequel on peut entendre le groupe chanter a cappela à la façon d'un opéra ? (bohemian rhapsody)
...
Quel département français a la chance d'avoir le numéro 13 ? (Bouches du Rhône)
...
Quel trio de comique chantait "et les keufs et les meufs dans le RER" ? (les Inconnus)
